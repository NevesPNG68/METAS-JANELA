  ...
  return (
    <>
      <div
        ...
        className="min-h-screen bg-janela-black text-white selection:bg-janela-yellow selection:text-black font-sans pb-10"
      >
        {/* Navbar / Header */}
                ...
                {metrics.ticket.current < metrics.ticket.target ? (
                  <>
                    ...
                    <span className="text-red-400 font-bold">
                      R$ {(metrics.ticket.target - metrics.ticket.current).toFixed(2)}
                    </span>{' '}
                    abaixo do ideal.
                  </>
                ) : (
